CREATE OR REPLACE PACKAGE ILP_PK_TOPUP IS
    ...
    FUNCTION saveTopup(PPROCESSID IN NUMBER, PUPDATEUSER IN VARCHAR2) RETURN NUMBER;
...
CREATE OR REPLACE PACKAGE BODY ILP_PK_TOPUP IS
    ...
    PROCEDURE validateSumValue(sumAlloc IN NUMBER, pErrors IN OUT wtErrorList) IS
    BEGIN
    ...
    FUNCTION saveTopup(pProcessId IN NUMBER, pUpdateUser IN VARCHAR2) RETURN NUMBER IS
